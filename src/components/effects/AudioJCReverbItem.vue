      ...
      <div class="flex items-center justify-between gap-3">
        <div class="flex min-w-0 flex-1 items-center gap-2">
          ...
          <div class="min-w-0 flex-1">
            <p class="truncate text-[13px] font-medium leading-tight text-zinc-50">JC Reverb</p>
          </div>
        </div>
...
const roomSizeLabel = computed(() => Number(props.effect.params.roomSize ?? 0.5).toFixed(2))

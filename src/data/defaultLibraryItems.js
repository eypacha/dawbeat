export const DEFAULT_LIBRARY_ITEMS = [
    {
      "id": "QHYHH4s7zDN72EDXGIpXY",
      "name": "Street Surfer - Skurk",
    ...
    {
      "id": "DuwEDYmSolD55Ko893Bb_",
      "name": "Psychedelica - SthephanShi",
    ...
    {
      "id": "C8Cd7Uo7bCDmYk6Hv1MGD",
      "name": "ONE MILLION alarm clocks - Yehar",
    ...
    {
      "id": "fh7ezrW3FJmrVJCLzKzjU",
      "name": "New sawtooth music - Gabriel Miceli",
    ...
    {
      "id": "I3GnScinvnJ8mEZssBki7",
      "name": "Music for a C64 game - Skurk",
    ...
    {
      "id": "HHR7LmPBvdAbNy3lz5ZjV",
      "name": "Mr. arpeggiator's cousin as bassist - Tonic",
      "formula": "(t/4&244)>>t/((t>>14&3)+4)",
      "leftFormula": "",
      "rightFormula": "",
      "formulaStereo": false,
      "duration": 5
    ...
    {
      "id": "lmeoB_rp8efbquKo__ZZK",
      "name": "Mr. arpeggiator playing a solo - Tonic",
    ...
    {
      "id": "hIgQwzKXgOg7N_B0XwCCR",
      "name": "Lemmings March - Marmakoide",
    ...
    {
      "id": "8ZTS_Z_iIFErRnzFyx6o7",
      "name": "Good old fractal melody - Blueberry",
    ...
    {
      "id": "6tMTIKxPCGQtJXdk7PV2p",
      "name": "Generic 3/4 buildup - Yumeji",
    ...
    {
      "id": "qjmrl2bs7B9ci1lnRMqA_",
      "name": "Fractal trees - 216",
    ...
    {
      "id": "4n4d5k0Ax3RrDyW58M8B8",
      "name": "Clean melody - Niklas_Roy",
    ...
    {
      "id": "a_pq_4FRpU62nO2GPvsEk",
      "name": "Brain burner - SthephanShi",
      "formula": "129*t%(t>>7)",
      "leftFormula": "",
      "rightFormula": "",
      "formulaStereo": false,
    ...
    {
      "id": "BzquCWsjOEF9NZPbSwa_W",
      "name": "Arcade game - Niklas_Roy",
    ...
    {
      "id": "jXIEe4lT1pyspA4aitO44",
      "name": "A jaunty tune - Ryg",
    ...
    },
    {
      ...
      "name": "Alien dungeon - SthephanShi",
    ...
    },
    {
      ...
      "name": "Sierpinsky Minimal - Viznut",
      "formula": "t&t>>8",
      "leftFormula": "",
      "rightFormula": "",
      "formulaStereo": false,
